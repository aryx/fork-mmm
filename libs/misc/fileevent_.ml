...
let add_fileinput_ref = ref (fun _ _ ->
    Logs.err (fun m -> m "TODO: File_event.add_fileinput")
)
let remove_fileinput_ref = ref (fun _ ->
    Logs.err (fun m -> m "TODO: File_event.remove_fileinput")
)
let add_fileoutput_ref = ref (fun _ _ ->
    Logs.err (fun m -> m "TODO: File_event.add_fileoutput")
)
let remove_fileoutput_ref = ref (fun _ ->
    Logs.err (fun m -> m "TODO: File_event.remove_fileoutput")
)
